...
<body>
    <form action="?id=<?= $id ?>" method="post">
        ...
        <label for="stock_action">Status</label><span class="error">*</span>
        <input type="radio" class="stocks" value="in" name="stock_action" id="stockin" <?= $status == 'in' ? 'checked' : '' ?>><label for="stockin">Stock In</label>
        <input type="radio" class="stocks" value="out" name="stock_action" id="stockout" <?= $status == 'out' ? 'checked' : '' ?>><label for="stockout">Stock Out</label>
        <br>
